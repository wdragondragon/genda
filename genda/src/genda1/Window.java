...
//		setOpacity(0.95f);
	...
	void setNew() {
		setLayout(null);
		Object name[] = { "", "速度", "击键", "码长", "字数", "回改", "退格", "错字", "选重",
				"键准", "打词率", "时间(秒)" }, a[][] = null;
		// 字体大小
		...
		JTextPaneChange.createStyle("黑", JTextPaneChange.styledDoc, fontSize,
				0, 0, 0, Color.BLACK, family, rightcolor);
		JTextPaneChange.createStyle("红", JTextPaneChange.styledDoc, fontSize,
				0, 0, 0, Color.BLACK, family, mistakecolor);
		JTextPaneChange.createStyle("灰", JTextPaneChange.styledDoc, fontSize,
				0, 0, 0, Color.BLACK, family, mistakecolor);// GRAY

		JTextPaneChange.createStyle("蓝粗", JTextPaneChange.styledDoc, fontSize,
				1, 0, 0, smacicolor, family, mistakecolor);// GRAY
		JTextPaneChange.createStyle("蓝", JTextPaneChange.styledDoc, fontSize,
				0, 0, 0, smacicolor, family, mistakecolor);// GRAY
		JTextPaneChange.createStyle("蓝斜", JTextPaneChange.styledDoc, fontSize,
				0, 1, 0, smacicolor, family, mistakecolor);// GRAY
		JTextPaneChange.createStyle("蓝粗斜", JTextPaneChange.styledDoc, fontSize,
				1, 1, 0, smacicolor, family, mistakecolor);// GRAY
		JTextPaneChange.createStyle("粉粗", JTextPaneChange.styledDoc, fontSize,
				1, 0, 0, emacicolor, family, mistakecolor);// GRAY
		JTextPaneChange.createStyle("粉", JTextPaneChange.styledDoc, fontSize,
				0, 0, 0, emacicolor, family, mistakecolor);// GRAY
		JTextPaneChange.createStyle("粉斜", JTextPaneChange.styledDoc, fontSize,
				0, 1, 0, emacicolor, family, mistakecolor);// GRAY
		JTextPaneChange.createStyle("粉粗斜", JTextPaneChange.styledDoc, fontSize,
				1, 1, 0, emacicolor, family, mistakecolor);// GRAY

		JTextPaneChange.createStyle("绿粗", JTextPaneChange.styledDoc, fontSize,
				1, 0, 0, qmacicolor, family, mistakecolor);// GRAY
		JTextPaneChange.createStyle("绿", JTextPaneChange.styledDoc, fontSize,
				0, 0, 0, qmacicolor, family, mistakecolor);// GRAY
		JTextPaneChange.createStyle("绿斜", JTextPaneChange.styledDoc, fontSize,
				0, 1, 0, qmacicolor, family, mistakecolor);// GRAY
		JTextPaneChange.createStyle("绿粗斜", JTextPaneChange.styledDoc, fontSize,
		...
		allnumber = new JLabel("总:" + String.valueOf(Window.fontallnum) + " 对:"
	...
	ActionListener lookda = new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			if (Pattern == 1) {
				...
				JTextPaneChange.createStyle("黑", JTextPaneChange.styledDoc,
						Window.fontSize, 0, 0, 0, Color.BLACK, Window.family,
						Window.rightcolor);
				JTextPaneChange.createStyle("红", JTextPaneChange.styledDoc,
						Window.fontSize, 0, 0, 0, Color.BLACK, Window.family,
						Window.mistakecolor);
			} else if (Pattern == 0) {
				Pattern = 1;
