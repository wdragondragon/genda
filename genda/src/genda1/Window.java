...
public class Window extends JFrame {
  ...
  InputMap F3Key, zaiwenKey, qqzaiwenKey, sendChengji, readyKey, shareKey, changeQQButtonKey,
      setKey, fawenKey;
  ...
  void setNew() {
    setLayout(null);
    Object name[] = {"", "速度", "击键", "码长", "字数", "回改", "退格", "错字", "选重", "键准",
        "打词率", "时间(秒)"},
           a[][] = null;
    // 字体大小
    ...
    JTextPaneChange.createStyle(
        "黑", JTextPaneChange.styledDoc, fontSize, 0, 0, 0, Color.BLACK, family, rightcolor);
    JTextPaneChange.createStyle(
        "红", JTextPaneChange.styledDoc, fontSize, 0, 0, 0, Color.BLACK, family, mistakecolor);
    JTextPaneChange.createStyle("灰", JTextPaneChange.styledDoc, fontSize, 0, 0, 0, Color.BLACK,
        family, mistakecolor); // GRAY

    JTextPaneChange.createStyle("蓝粗", JTextPaneChange.styledDoc, fontSize, 1, 0, 0, smacicolor,
        family, mistakecolor); // GRAY
    JTextPaneChange.createStyle("蓝", JTextPaneChange.styledDoc, fontSize, 0, 0, 0, smacicolor,
        family, mistakecolor); // GRAY
    JTextPaneChange.createStyle("蓝斜", JTextPaneChange.styledDoc, fontSize, 0, 1, 0, smacicolor,
        family, mistakecolor); // GRAY
    JTextPaneChange.createStyle("蓝粗斜", JTextPaneChange.styledDoc, fontSize, 1, 1, 0, smacicolor,
        family, mistakecolor); // GRAY
    JTextPaneChange.createStyle("粉粗", JTextPaneChange.styledDoc, fontSize, 1, 0, 0, emacicolor,
        family, mistakecolor); // GRAY
    JTextPaneChange.createStyle("粉", JTextPaneChange.styledDoc, fontSize, 0, 0, 0, emacicolor,
        family, mistakecolor); // GRAY
    JTextPaneChange.createStyle("粉斜", JTextPaneChange.styledDoc, fontSize, 0, 1, 0, emacicolor,
        family, mistakecolor); // GRAY
    JTextPaneChange.createStyle("粉粗斜", JTextPaneChange.styledDoc, fontSize, 1, 1, 0, emacicolor,
        family, mistakecolor); // GRAY

    JTextPaneChange.createStyle("绿粗", JTextPaneChange.styledDoc, fontSize, 1, 0, 0, qmacicolor,
        family, mistakecolor); // GRAY
    JTextPaneChange.createStyle("绿", JTextPaneChange.styledDoc, fontSize, 0, 0, 0, qmacicolor,
        family, mistakecolor); // GRAY
    JTextPaneChange.createStyle("绿斜", JTextPaneChange.styledDoc, fontSize, 0, 1, 0, qmacicolor,
        family, mistakecolor); // GRAY
    JTextPaneChange.createStyle("绿粗斜", JTextPaneChange.styledDoc, fontSize, 1, 1, 0, qmacicolor,
        family, mistakecolor); // GRAY
    ...
    allnumber = new JLabel("总:" + String.valueOf(Window.fontallnum)
        + " 对:" + String.valueOf(Window.rightnum) + " 错:" + String.valueOf(Window.misnum)
        + " 今:" + String.valueOf(Window.datenum));
    ...
    ImageIcon icon =
        new ImageIcon("images//installer_repair_1.png"); // xxx代表图片存放路径，2.png图片名称及格式
  ...
  void menu() {
    ...
    jqbzaiwen.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_E, KeyEvent.CTRL_MASK));
  ...
  void FlowLayout() {
    Winchg = new winchange(rightce, size, max, close, wenben, dazi, accept1, jSplitPane1, this,
        tableN, gendajindutiao);
    Winchg.start();
  }
  ...
  void Client() {
    clientNew();
    setReadyKey();
    onlineListener.setRoomNum(reducesudu, one, two, three, four, five, six, seven, eight, link,
        breaklink, accept1, ready, score, communion1, this);
  ...
  ActionListener lookda = new ActionListener() {
    public void actionPerformed(ActionEvent e) {
      if (Pattern == 1) {
        ...
        JTextPaneChange.createStyle("黑", JTextPaneChange.styledDoc, Window.fontSize, 0, 0, 0,
            Color.BLACK, Window.family, new Color(238, 238, 238));
        JTextPaneChange.createStyle("红", JTextPaneChange.styledDoc, Window.fontSize, 0, 0, 0,
            Color.BLACK, Window.family, new Color(238, 238, 238));
      } else if (Pattern == 2) {
        Pattern = 0;
