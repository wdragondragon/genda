...
//					System.out.println("退格+");
				...
				KeyNumber++;
				fengkeytemp++;
				KeysuduButton.setText(String.format("%.2f",KeyNumber/comp.getSecond()));
			}
...
//				System.out.println("退格+");
		...
		catch(Exception ex){System.out.println("跟打框无字1");}
	}
	@Override
...
//					System.out.println("退格+2");
		...
		}catch(Exception ex){System.out.println("跟打框无字2");}
	}
	@Override
...
//			n = 0;
			...
			if(n>dangyenum*(fenye-1)+Integer.valueOf(SetFrame.readyFont.getText())){
				...
				for(;n<tempready;n++){
					...
					JTextPaneChange.createStyle("预读", JTextPaneChange.styledDoc, Window.fontSize,
							0, 0, 0,wenben.getBackground(), Window.family, wenben.getBackground());
					JTextPaneChange.insertDoc(JTextPaneChange.styledDoc,String.valueOf(c2[n]),"预读",wenben);
				}
			}
			for(;n<last;n++){			//添加剩下字体
//				System.out.print(n);
				if(SetFramechangeListener.tipsign==0||Window.everydaySign||(Window.Pattern==1)){
					...
					if(quanmanum!=-1){
						if(quanmanum%2==0)
							for(int k=Tips.quanmacione.get(quanmanum);k<=Tips.quanmacitwo.get(quanmanum);k++){
								JTextPaneChange.insertDoc(JTextPaneChange.styledDoc,String.valueOf(c2[k]),"绿粗",wenben);
							}
						else{
							for(int k=Tips.quanmacione.get(quanmanum);k<=Tips.quanmacitwo.get(quanmanum);k++){
								JTextPaneChange.insertDoc(JTextPaneChange.styledDoc,String.valueOf(c2[k]),"绿",wenben);	
							}
						}
						...
						if(ejianmanum%2==0)
							for(int k=Tips.ejianmacione.get(ejianmanum);k<=Tips.ejianmacitwo.get(ejianmanum);k++){
								JTextPaneChange.insertDoc(JTextPaneChange.styledDoc,String.valueOf(c2[k]),"粉粗",wenben);
							}
						else{
							for(int k=Tips.ejianmacione.get(ejianmanum);k<=Tips.ejianmacitwo.get(ejianmanum);k++){
								JTextPaneChange.insertDoc(JTextPaneChange.styledDoc,String.valueOf(c2[k]),"粉",wenben);
							}
						}
						...
						if(sjianmanum%2==0)
							for(int k=Tips.sjianmacione.get(sjianmanum);k<=Tips.sjianmacitwo.get(sjianmanum);k++){
								JTextPaneChange.insertDoc(JTextPaneChange.styledDoc,String.valueOf(c2[k]),"蓝粗",wenben);
							}
						else{
							for(int k=Tips.sjianmacione.get(sjianmanum);k<=Tips.sjianmacitwo.get(sjianmanum);k++){
								JTextPaneChange.insertDoc(JTextPaneChange.styledDoc,String.valueOf(c2[k]),"蓝",wenben);
							}
						}
						...
						if(ciquanmanum%2==0)
							for(int k=Tips.ciquanmacione.get(ciquanmanum);k<=Tips.ciquanmacitwo.get(ciquanmanum);k++){
								JTextPaneChange.insertDoc(JTextPaneChange.styledDoc,String.valueOf(c2[k]),"绿粗斜",wenben);
							}
						else{
							for(int k=Tips.ciquanmacione.get(ciquanmanum);k<=Tips.ciquanmacitwo.get(ciquanmanum);k++){
								JTextPaneChange.insertDoc(JTextPaneChange.styledDoc,String.valueOf(c2[k]),"绿斜",wenben);	
							}
						}
						...
						if(ciejianmanum%2==0)
							for(int k=Tips.ciejianmacione.get(ciejianmanum);k<=Tips.ciejianmacitwo.get(ciejianmanum);k++){
								JTextPaneChange.insertDoc(JTextPaneChange.styledDoc,String.valueOf(c2[k]),"粉粗斜",wenben);
							}
						else{
							for(int k=Tips.ciejianmacione.get(ciejianmanum);k<=Tips.ciejianmacitwo.get(ciejianmanum);k++){
								JTextPaneChange.insertDoc(JTextPaneChange.styledDoc,String.valueOf(c2[k]),"粉斜",wenben);
							}
						}
						...
						if(cisjianmanum%2==0)
							for(int k=Tips.cisjianmacione.get(cisjianmanum);k<=Tips.cisjianmacitwo.get(cisjianmanum);k++){
								JTextPaneChange.insertDoc(JTextPaneChange.styledDoc,String.valueOf(c2[k]),"蓝粗斜",wenben);
							}
						else{
							for(int k=Tips.cisjianmacione.get(cisjianmanum);k<=Tips.cisjianmacitwo.get(cisjianmanum);k++){
								JTextPaneChange.insertDoc(JTextPaneChange.styledDoc,String.valueOf(c2[k]),"蓝斜",wenben);
							}
						}
