...
public class JTextPaneChange {
	...
	static public void insertDoc(StyledDocument styledDoc, String content,String currentStyle,JTextPane wenben)
	{
		try {
//			wenben.setText("");
	...
	static public void createStyle(String style,StyledDocument doc,int size,int bold,int italic,int underline,Color color,String fontName,Color backcolor)
	{
		sys = StyleContext.getDefaultStyleContext().getStyle(StyleContext.DEFAULT_STYLE);
		try { doc.removeStyle(style); } catch(Exception e) {} //先删除这种Style,假使他存在
