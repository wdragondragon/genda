...
public class winchange extends Thread implements ActionListener {
  ...
  winchange(JButton ce, JButton size, JButton max, JButton close, JTextPane one, JTextArea two,
      JScrollPane accept, JSplitPane jSplitPane1, Window win, JScrollPane tableN,
      JProgressBar gendajindutiao) {
    this.wenben = one;
    this.dazi = two;
      ...
      try {
        ...
        if (n > 0) {
          ...
          if (!accept.isVisible()) {
            heightOne = heigthTwo;
            heigthTwo = win.getHeight();
            jSplitPane1.setBounds(jsplitX, win.suduButton.getY() + win.suduButton.getHeight() + 5,
                move - 5, jSplitPane1.getHeight() + (heigthTwo - heightOne)); // 295
            gendajindutiao.setBounds(jsplitX,
                jSplitPane1.getY() + jSplitPane1.getHeight() + (heigthTwo - heightOne), move - 5,
                10); // 341
            ...
            ce.setBounds(jSplitPane1.getX() + jSplitPane1.getWidth(), jSplitPane1.getY(), 5,
                jSplitPane1.getHeight());

          } else {
            jSplitPane1.setBounds(jsplitX, win.suduButton.getY() + win.suduButton.getHeight() + 5,
                move - 5 - 200, jSplitPane1.getHeight()); // 295
            gendajindutiao.setBounds(
                jsplitX, jSplitPane1.getY() + jSplitPane1.getHeight(), move - 5 - 200, 10); // 341
            accept.setBounds(jsplitX, gendajindutiao.getY() + gendajindutiao.getHeight() + 45,
                move - 5 - 200, 200); // 460
          ...
          win.qqName.setBounds(
              jSplitPane1.getX() - 5, jSplitPane1.getY() + jSplitPane1.getHeight() + 10, 120, 40);
          win.zishu.setBounds(jSplitPane1.getX() - 5 + win.qqName.getWidth() + 5,
              jSplitPane1.getY() + jSplitPane1.getHeight() + 10,
              (win.zishu.getText().length() - 5) * 7 + 5 * 12, 40);
          win.allnumber.setBounds(
              jSplitPane1.getX() - 5 + (win.qqName.getWidth() + win.zishu.getWidth() + 10),
              jSplitPane1.getY() + jSplitPane1.getHeight() + 10,
              (win.allnumber.getText().length() - 4) * 7 + 4 * 12, 40);
          win.tips.setBounds(jSplitPane1.getX() - 5
                  + (win.qqName.getWidth() + win.zishu.getWidth() + win.allnumber.getWidth() + 15),
              jSplitPane1.getY() + jSplitPane1.getHeight() + 10, win.tips.getText().length() * 15,
              40);
          win.sendwen.setBounds(jSplitPane1.getX() - 5
                  + (win.qqName.getWidth() + win.zishu.getWidth() + win.allnumber.getWidth()
                        + win.tips.getWidth() + 20),
              jSplitPane1.getY() + jSplitPane1.getHeight() + 10, win.sendwen.getText().length() * 8,
              40);
          ...
          win.lookplayfinish.setBounds(
              win.sendwen.getX() + win.sendwen.getWidth(), win.sendwen.getY() + 5, 100, 30);
          win.leftce.setBounds(
              win.jSplitPane1.getX() - 5, win.jSplitPane1.getY(), 5, jSplitPane1.getHeight());
