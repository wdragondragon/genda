...
public class ComputeSpeed {
  ...
  public double getSpeed(double length, int mistake) {
    BigInteger timeOne = new BigInteger(String.valueOf(time1)),
               timeTwo = new BigInteger(String.valueOf(time2)), time = new BigInteger("0");
  ...
  public void substractStopTime() {
    BigInteger timeStopOne = new BigInteger(String.valueOf(stopTime1)),
               timeStopTwo = new BigInteger(String.valueOf(stopTime2)),
               timeOne = new BigInteger(String.valueOf(time1)), time = new BigInteger("0");
