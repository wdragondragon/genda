  ...
  public void denglu() {
    if (Login.dengluSign == 0) {
      try {
        ...
        //ObjectOutputStream(Login.out); 				ObjectInputStream inputByServer = new
        ...
        if (!what.substring(0, 4).equals("版本正确")) {
          ...
          if (n == JOptionPane.YES_OPTION) {
            ...
            if (Example.systemname.length() >= 7
                && Example.systemname.substring(0, 7).equals("Windows"))
            ...
            Runtime.getRuntime().exec(
                "rundll32 url.dll,FileProtocolHandler http://39.96.83.89/new.zip");
            return;
          }
        }
        ...
        if (i == 1) {
          ...
          //					SendQQMessage.sendmessage(Login.zhanghao.getText() +
          //"已上线，（上线消息只会发送到拖拉机交流群）");
