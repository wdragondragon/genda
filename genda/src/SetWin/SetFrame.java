...
public class SetFrame extends JFrame {
  ...
  public void SetFrame1() {
    ...
    MistakecolorSet.setBounds(
        RightcolorSet.getX() + RightcolorSet.getWidth() + 10, RightcolorSet.getY(), 100, 30);
    p.add(MistakecolorSet);

    JButton WenbenBackgroundSet = new JButton("文本框背景颜色");
    WenbenBackgroundSet.setBounds(
        MistakecolorSet.getX() + MistakecolorSet.getWidth() + 10, RightcolorSet.getY(), 140, 30);
    p.add(WenbenBackgroundSet);

    JButton qmccolorset = new JButton("全码词颜色");
    qmccolorset.setBounds(WenbenBackgroundSet.getX() + WenbenBackgroundSet.getWidth() + 10,
        RightcolorSet.getY(), 140, 30);
    p.add(qmccolorset);

    JButton BackgroundSet = new JButton("整体界面颜色");
    BackgroundSet.setBounds(
        RightcolorSet.getX(), RightcolorSet.getY() + RightcolorSet.getHeight() + 10, 140, 30);
    p.add(BackgroundSet);

    JButton DaziBackgroundSet = new JButton("打字框背景颜色");
    DaziBackgroundSet.setBounds(BackgroundSet.getX() + BackgroundSet.getWidth() + 10,
        RightcolorSet.getHeight() + RightcolorSet.getY() + 10, 140, 30);
    p.add(DaziBackgroundSet);

    JButton emccolorset = new JButton("二码词颜色");
    emccolorset.setBounds(DaziBackgroundSet.getX() + DaziBackgroundSet.getWidth() + 10,
        RightcolorSet.getHeight() + RightcolorSet.getY() + 10, 100, 30);
    p.add(emccolorset);

    JButton smccolorset = new JButton("三码词颜色");
    smccolorset.setBounds(emccolorset.getX() + emccolorset.getWidth() + 10,
        RightcolorSet.getHeight() + RightcolorSet.getY() + 10, 100, 30);
    p.add(smccolorset);

    FontSize = new JTextField("填入字号:保存");
    FontSize.setBounds(
        BackgroundSet.getX(), BackgroundSet.getY() + BackgroundSet.getHeight() + 10, 70, 30);
    ...
    changeFontSize.setBounds(FontSize.getX() + FontSize.getWidth() + 10,
        BackgroundSet.getY() + BackgroundSet.getHeight() + 10, 60, 30);
    p.add(changeFontSize);

    Splitenum = new JTextField("分页字数:保存");
    Splitenum.setBounds(changeFontSize.getX() + changeFontSize.getWidth() + 10,
        BackgroundSet.getY() + BackgroundSet.getHeight() + 10, 70, 30);
    ...
    splitebutton.setBounds(Splitenum.getX() + Splitenum.getWidth() + 10,
        BackgroundSet.getY() + BackgroundSet.getHeight() + 10, 60, 30);
    p.add(splitebutton);

    JButton mabiao = new JButton("全码表选择");
    mabiao.setBounds(splitebutton.getX() + splitebutton.getWidth() + 10,
        BackgroundSet.getY() + BackgroundSet.getHeight() + 10, 100, 30);
    p.add(mabiao);
    ...
    zhiding.setBounds(mabiao.getX() + mabiao.getWidth() + 10,
        BackgroundSet.getY() + BackgroundSet.getHeight() + 10, 100, 30);
    ...
    familyque.setBounds(family.getX() + family.getWidth() + 10,
        FontSize.getY() + FontSize.getHeight() + 10, 90, 30);
    p.add(familyque);

    readyFont = new JTextField("0");
    readyFont.setBounds(familyque.getX() + familyque.getWidth() + 10,
        FontSize.getY() + FontSize.getHeight() + 10, 90, 30);
