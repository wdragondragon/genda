...
public class historyFrame extends JFrame implements ActionListener {
  ...
  void init() {
    ...
    p.setLayout(null);
    add(p);
    Object name[] = {"", "日期", "速度", "击键", "码长", "字数", "回改", "退格", "错字", "选重",
        "键准", "键法", "打词率", "时间(秒)", "段数"},
           a[][] = null;
    ...
    lookwenben.setBounds(140, tableN.getY() + tableN.getHeight() + 35, 120, 30);
    ...
    shaixuandate.setBounds(340, tableN.getY() + tableN.getHeight() + 35, 90, 30);
    shaixuansudu.setBounds(520, tableN.getY() + tableN.getHeight() + 35, 90, 30);
    shaixuansaiwen.setBounds(620, tableN.getY() + tableN.getHeight() + 35, 120, 30);
  ...
  public static void showtable() {
    ...
    vRow1.add(duanwei);
    tableM.addRow(vRow1);
    for (int i = fenye * dangqian; i < fenye * (dangqian + 1); i++) try {
  ...
  public static void clear() {
    while (historyFrame.table.getRowCount() > 0) historyFrame.tableM.removeRow(0);
  }
